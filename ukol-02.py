...
if kod in sklad:
    ...
    if kolik > sklad[kod]:
        ...
        print("Poptávku lze splnit v plné výši.")
        sklad[kod] -= kolik
else:
    print(f"Součástka s kódem {kod} není skladem.")
...
for stat in staty:
    if region in stat["region"]:
        staty_v_regionu.append(stat["name"])

if len(staty_v_regionu) == 0:
    print("Neznámý region.")
else:
    staty_v_regionu = ", ".join(staty_v_regionu)
    print(f"V regionu {region} se nacházejí tyto státy: {staty_v_regionu}.")
